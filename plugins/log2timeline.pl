...
#timescanner  -zone UTC -format win7  -write /export/client/lyra/wpcu-40008/log2timeline/timescanned.bodyfile -log /export/client/lyra/wpcu-40008/log2timeline/timescanned.bodyfile.log -d ./drive
my $timescannertext = $timescannerbin . " -zone " . $timezone;
$timescannertext .= " -format ".$OS." "; #Format of the image
$timescannertext .= " -write ".$savedir."timescanned.bodyfile";
$timescannertext .= " -log " .$savedir."timescanned.bodyfile.log";
...
$timescannertext = $timescannerbin . " -zone UTC -format win7  -write ".$savedir."timescanned.bodyfile -log " .$savedir."timescanned.bodyfile.log -d ".$dir;
